  ...
  return (
    <div>
      ...
      <p className="texto-ayuda">
        El filtro de fecha muestra canchas con horario ese día de la semana. Si además eliges una hora, solo verás las canchas con ese bloque de 1 hora libre; los bloques se confirman en el detalle de cada cancha.
      </p>
